...
String resolvePaymentStatusLabel(
  ...
  return switch (status) {
    ...
    MiniAppPaymentStatus.pending => throw UnimplementedError(),
    // TODO: Handle this case.
    MiniAppPaymentStatus.paid => throw UnimplementedError(),
    // TODO: Handle this case.
    MiniAppPaymentStatus.unknown => throw UnimplementedError(),
  };
}
