              ...
              MiniAppAdaptivePressable(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: actionEnabled ? DesignTokens.primaryGradient : null,
                    color: actionEnabled ? null : const Color(0xFFECE7E0),
                    border: actionEnabled ? null : Border.all(color: const Color(0xFFD9D1C5)),
                    boxShadow: actionEnabled ? DesignTokens.buttonShadow : const <BoxShadow>[],
                  ),
                  child: Icon(
...
class BottomNavigationConfig {
  static const int homeIndex = CustomNavbar.homeIndex;
  static const int profileIndex = CustomNavbar.profileIndex;
