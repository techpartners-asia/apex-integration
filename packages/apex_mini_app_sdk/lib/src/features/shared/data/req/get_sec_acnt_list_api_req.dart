class GetSecuritiesAcntListApiReq {
  ...
  Map<String, Object?> toJson() {
    return <String, Object?>{
      ...
      if (ipoCode case final String value when value.trim().isNotEmpty) 'ipoCode': value.trim(),
      if (mobile case final String value when value.trim().isNotEmpty) 'mobile': value.trim(),
      'acnts': acnts,
      'srcFiCode': srcFiCode,
    };
  }
