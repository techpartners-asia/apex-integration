...
class GetSecAcntListAccountDto {
  ...
  factory GetSecAcntListAccountDto.fromJson(Map<String, Object?> json) {
    return GetSecAcntListAccountDto(
      ...
      nominalList: ApiParser.asObjectMapList(json['nominalList']).map(NominalListResDto.fromJson).toList(growable: false),
      ...
      balances: ApiParser.asObjectMapList(json['balances']).map(BalancesDto.fromJson).toList(growable: false),
      bals: ApiParser.asObjectMapList(json['bals']).map(BalsDto.fromJson).toList(growable: false),
