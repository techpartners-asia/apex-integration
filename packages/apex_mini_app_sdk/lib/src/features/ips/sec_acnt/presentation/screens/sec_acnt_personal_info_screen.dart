...
class _SecAcntPersonalInfoScreenState extends State<SecAcntPersonalInfoScreen> {
  ...
  void initState() {
    ...
    _secondaryMobileController = TextEditingController(text: widget.initialDraft.secondaryMobile);
  ...
  String? _validateMobile(BuildContext context, String? value) {
    ...
    return InvestXValidators.combine(<InvestXStringValidator>[
      InvestXValidators.required(context.l10n),
      InvestXValidators.phone(context.l10n),
    ])(value);
  }

  String? _validateSecondaryMobile(BuildContext context, String? value) {
    return InvestXValidators.phone(context.l10n, required: false)(value);
  }
  ...
  String? _validateEmail(BuildContext context, String? value) {
    ...
    return InvestXValidators.email(context.l10n)(value);
  }

  String? _validateIban(BuildContext context, String? value) {
    return InvestXValidators.iban(context.l10n)(value);
  }

  String? _validateSelectedBank(BuildContext context) {
    return InvestXValidators.requiredSelection<SecAcntBankOption>(context.l10n)(
      _selectedBank,
    );
  }
  ...
  Future<void> _submitAndOpenNextStep() async {
    ...
    try {
      await _profileSubmissionService.submit(UpdateProfileActionType.updateProfile, draft.toPersonalInfoData());
    } catch (error) {
      if (!mounted) {
        return;
      }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SecAcntPersonalInfoStep(
                    ...
                    autovalidateMode: _didInteractWithPersonalInfo ? AutovalidateMode.always : AutovalidateMode.disabled,
                    ...
                    bankErrorText: (_didInteractWithPersonalInfo || _didTouchBankSelector) ? _validateSelectedBank(context) : null,
                  ),
                  if (_submitErrorMessage != null && _submitErrorMessage!.trim().isNotEmpty) ...<Widget>[
                    SizedBox(height: context.responsive.dp(20)),
                    InvestXNoticeBanner(
