...
bool isShortSecAcntFlow(AcntBootstrapState? state) => hasSecAcnt(state) && !requiresSecAcntOpeningPayment(state);
...
class SecAcntFlowDraft {
  ...
  factory SecAcntFlowDraft.fromBootstrap(AcntBootstrapState? state, {UserEntityDto? user}) {
    ...
    final String? acntName = _sanitizeIbanDigits(_resolveBootstrapAcntName(state, user: user));
...
String? _resolveBootstrapBankCode(AcntBootstrapState? state, {UserEntityDto? user}) {
...
String? _resolveBootstrapBankName(AcntBootstrapState? state, {UserEntityDto? user}) {
...
String? _resolveBootstrapAcntName(AcntBootstrapState? state, {UserEntityDto? user}) {
...
String? _resolveBootstrapIban(AcntBootstrapState? state, {UserEntityDto? user}) {
