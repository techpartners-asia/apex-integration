...
import 'portfolio_yield_widgets.dart';
...
const List<Color> kPieChartPalette = <Color>[
  ...
  InvestXDesignTokens.successStrong,
...
List<LinearGradient> kPieChartGradient = <LinearGradient>[
  LinearGradient(colors: [InvestXDesignTokens.rose, InvestXDesignTokens.softPeach]),
  LinearGradient(colors: [InvestXDesignTokens.softPeach, InvestXDesignTokens.coral]),
  LinearGradient(colors: [InvestXDesignTokens.primaryTeal, InvestXDesignTokens.darkTeal]),
  LinearGradient(colors: [InvestXDesignTokens.ink, InvestXDesignTokens.muted]),
  LinearGradient(colors: [InvestXDesignTokens.success, InvestXDesignTokens.successStrong]),
  LinearGradient(colors: [InvestXDesignTokens.selectionBlue, InvestXDesignTokens.selectionBlueBorder]),
  LinearGradient(colors: [InvestXDesignTokens.roseGlow, InvestXDesignTokens.roseTint]),
  LinearGradient(colors: [InvestXDesignTokens.muted, InvestXDesignTokens.border]),
        ...
        InvestXSectionCard(
          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                Expanded(
                  child: InvestXAllocationMetricRow(
          ...
          child: Center(
            child: AnimatedDefaultTextStyle(
              ...
              style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                color: isSelected ? InvestXDesignTokens.ink : const Color(0xFF6B7280),
              ...
              child: CustomText(
                ...
                color: isSelected ? InvestXDesignTokens.ink : InvestXDesignTokens.muted,
              ),
            ),
          ),
        ),
...
class _PortfolioSecurityTileState extends State<PortfolioSecurityTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color toneColor = isPositive ? InvestXDesignTokens.success : InvestXDesignTokens.danger;
