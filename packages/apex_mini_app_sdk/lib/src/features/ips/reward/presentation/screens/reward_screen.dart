      ...
      child: Column(
        ...
        children: <Widget>[
          CustomText(
            ...
            style: Theme.of(context).textTheme.titleSmall?.copyWith(
              fontWeight: MiniAppTypography.bold,
              color: InvestXDesignTokens.primaryTeal,
            ),
          ),
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        _MilestoneRow(
          ...
          iconColor: InvestXDesignTokens.success,
          isActive: false,
          isCompleted: true,
        ),
        _MilestoneRow(
          ...
          iconColor: InvestXDesignTokens.rose,
          isActive: true,
          isCompleted: false,
        ...
        _MilestoneRow(
          ...
          iconColor: InvestXDesignTokens.muted,
          isActive: false,
          isCompleted: false,
        ),
        _MilestoneRow(
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isActive
                ? InvestXDesignTokens.rose.withValues(alpha: 0.3)
                : InvestXDesignTokens.border,
          ),
        ),
        padding: EdgeInsets.symmetric(
          ...
          children: <Widget>[
            ...
            if (statusLabel != null)
              Container(
                ...
                decoration: BoxDecoration(
                  color: InvestXDesignTokens.rose.withValues(alpha: 0.12),
                  borderRadius: BorderRadius.circular(responsive.radius(12)),
                ),
                child: CustomText(
                  statusLabel!,
