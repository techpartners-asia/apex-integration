        ...
        children: <Widget>[
          ...
          SliderTheme(
            data: SliderThemeData(
              ...
              activeTrackColor: InvestXDesignTokens.rose,
              inactiveTrackColor: InvestXDesignTokens.border,
              thumbColor: Colors.white,
              overlayColor: InvestXDesignTokens.rose.withValues(alpha: 0.12),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? InvestXDesignTokens.ink : Colors.white,
          ...
          child: Center(
            child: CustomText(
              ...
              variant: MiniAppTextVariant.caption,
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                color: isSelected ? Colors.white : InvestXDesignTokens.ink,
