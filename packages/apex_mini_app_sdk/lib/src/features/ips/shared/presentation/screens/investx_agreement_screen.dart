...
class InvestXAgreementScreen extends StatelessWidget {
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              Expanded(
                child: InvestXAgreementPageTemplate(
                  title: title,
                  body: body,
...
class InvestXAgreementHtmlBody extends StatelessWidget {
  const InvestXAgreementHtmlBody({super.key, required this.agreementText});
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: SelectionArea(
        child: Html(data: sanitizeInvestXAgreementHtml(agreementText)),
      ),
    );
  }
}

String sanitizeInvestXAgreementHtml(String raw) {
  return raw
