...
class InvestXTransactionTile extends StatelessWidget {
  final String title;
  ...
  Widget build(BuildContext context) {
    ...
    final Color accent = positive ? InvestXDesignTokens.success : InvestXDesignTokens.rose;
