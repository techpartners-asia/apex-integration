...
class InvestXAgreementBodyCard extends StatelessWidget {
  final Widget child;
  final EdgeInsetsGeometry? padding;
  final Color backgroundColor;
  final double? borderRadius;

  const InvestXAgreementBodyCard({
    super.key,
    required this.child,
    this.padding,
...
class InvestXAgreementPageTemplate extends StatelessWidget {
  final String? title;
  final Widget body;
  ...
  const InvestXAgreementPageTemplate({
    super.key,
    required this.body,
    this.title,
    this.consentLabel,
