...
class InvestXConsentCheckboxRow extends StatelessWidget {
  final String label;
  final bool accepted;
  final ValueChanged<bool> onAcceptedChanged;
  final Color activeColor;

  const InvestXConsentCheckboxRow({
    super.key,
    required this.label,
    required this.accepted,
    required this.onAcceptedChanged,
    this.activeColor = InvestXDesignTokens.rose,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final Color checkboxColor = accepted
        ? activeColor
        : InvestXDesignTokens.agreementUnchecked;
