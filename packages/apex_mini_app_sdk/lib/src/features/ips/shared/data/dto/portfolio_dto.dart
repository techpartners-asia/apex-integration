...
class PortfolioOverviewDto {
  ...
  factory PortfolioOverviewDto.fromJson(Map<String, Object?> json) {
    ApiActionResultParser.ensureSuccess(json, fallbackErrorMessage: 'IPS balance req failed.', strictResponseCode: true);

    final Map<String, Object?> responseData = ApiParser.asObjectMap(json['responseData']);
    final List<PortfolioSecurityDto> security = ApiParser.asObjectMapList(json['security']).map(PortfolioSecurityDto.fromJson).toList(growable: false);
    final Map<String, Object?> packDetail = ApiParser.asObjectMap(json['packDetail']);
    final double? stockTotal = ApiParser.asNullableDouble(responseData['stockTotal']);
    final double? bondTotal = ApiParser.asNullableDouble(responseData['bondTotal']);
    final double? cashTotal = ApiParser.asNullableDouble(responseData['cashTotal']);
...
class PortfolioHoldingDto {
  ...
  factory PortfolioHoldingDto.fromYieldProfitJson(Map<String, Object?> json) {
    return PortfolioHoldingDto(
      code: ApiParser.asNullableString(json['symbol']) ?? IpsDefaults.unknownSecurityCode,
      name: ApiParser.asNullableString(json['securityName']) ?? IpsDefaults.unknownSecurityName,
  ...
  factory PortfolioHoldingDto.fromStockYieldDetailJson(
    ...
    return PortfolioHoldingDto(
      code: ApiParser.asNullableString(json['securityCode']) ?? IpsDefaults.unknownSecurityCode,
      name: ApiParser.asNullableString(json['securityName']) ?? IpsDefaults.unknownSecurityName,
  ...
  static List<PortfolioHoldingDto> listFromStockYieldDetailResponse(Map<String, Object?> json) {
    ...
    if (yieldList.isNotEmpty) {
      return yieldList.map(PortfolioHoldingDto.fromStockYieldDetailJson).toList(growable: false);
    }
