...
import '../../application/help_cubit.dart';
...
class HelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InvestXPageScaffold(
      ...
      body: BlocBuilder<HelpCubit, LoadableState<CompaniesEntity>>(
        builder: (BuildContext context, LoadableState<CompaniesEntity> state) {
          ...
          final CompaniesEntity? company = state.data;
      ...
      children: <Widget>[
        ...
        ...rows.map(
          (e) => Padding(
            ...
            child: AdaptiveCard(
              color: InvestXDesignTokens.white,
              child: _ContactRow(
                label: e.label,
                value: e.value,
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Icon(
                                ...
                                color: InvestXDesignTokens.selectionBlue,
