...
import 'package:mini_app_sdk/src/utils/extension/extension.dart';
...
import '../../../shared/presentation/helpers/investx_design_tokens.dart';
...
class OverviewDashboardMetrics {
  ...
  static OverviewDashboardMetrics resolve(
    ...
    return OverviewDashboardMetrics(
      ...
      profitTone: profit < 0 ? InvestXDesignTokens.danger : InvestXDesignTokens.success,
