          ...
          OverviewProfileMenuCard(
            items: <OverviewProfileMenuItemData>[
              ...
              OverviewProfileMenuItemData(
                ...
                subtitleColor: InvestXDesignTokens.danger,
                  ...
                  errorBuilder:
                      (
                        ...
                        decoration: const BoxDecoration(
                          gradient: InvestXDesignTokens.primaryGradient,
                        ),
                ...
                Row(
                  children: <Widget>[
                    Icon(
                      ...
                      color: verified ? InvestXDesignTokens.success : InvestXDesignTokens.muted,
                    ),
...
class OverviewProfileMenuRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color titleColor = item.enabled ? InvestXDesignTokens.ink : InvestXDesignTokens.muted;
    final Color subtitleColor = item.subtitleColor ?? (item.enabled ? InvestXDesignTokens.muted : InvestXDesignTokens.border);
    final Color chevronColor = isEnabled ? InvestXDesignTokens.muted : InvestXDesignTokens.border;
