...
class CompanyInfoResponseDto {
  ...
  factory CompanyInfoResponseDto.fromJson(Map<String, Object?> json) {
    ...
    final List<SocialMediaEntity> socialLinks = _resolveSocialLinks(source, source);
...
List<SocialMediaEntity> _resolveSocialLinks(Map<String, Object?> source, Map<String, Object?> json) {
