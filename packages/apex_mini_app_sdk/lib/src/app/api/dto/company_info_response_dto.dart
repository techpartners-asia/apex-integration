...
class CompanyInfoResponseDto {
  ...
  factory CompanyInfoResponseDto.fromJson(Map<String, Object?> json) {
    ...
    final Map<String, Object?> nestedCompanyJson = ApiParser.asObjectMap(
      locationJson['company'],
    );
    ...
    return CompanyInfoResponseDto(
      entity: BranchInfoEntity(
        id:
            ApiParser.asNullableInt(source['id']) ??
            ApiParser.asNullableInt(nestedCompanyJson['id']),
        email:
            ApiParser.asNullableString(source['email']) ??
            ApiParser.asNullableString(nestedCompanyJson['email']),
        phone:
            ApiParser.asNullableString(source['phone']) ??
            ApiParser.asNullableString(nestedCompanyJson['phone']),
        location: locationJson.isEmpty
            ? null
            : LocationEntity.fromJson(locationJson),
        socialLinks: socialLinks,
        createdAt:
            ApiParser.asNullableString(source['created_at']) ??
            ApiParser.asNullableString(nestedCompanyJson['created_at']),
        updatedAt:
            ApiParser.asNullableString(source['updated_at']) ??
            ApiParser.asNullableString(nestedCompanyJson['updated_at']),
        message:
...
List<SocialMediaEntity> _resolveSocialLinks(
  ...
  final Object? rawLinks =
      nestedCompanyJson['socialLinks'] ??
      nestedCompanyJson['SocialLinks'] ??
      source['socialLinks'] ??
      source['SocialLinks'] ??
      locationJson['socialLinks'] ??
      locationJson['SocialLinks'];
